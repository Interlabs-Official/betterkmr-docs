...
- **Code Redeeming** – Unlock Easter Eggs from the Developers!
- **Welcome Popup** – Accept the TOS and Privacy Policy, and choose to enable Telemetry or Helicon upon install or update.
...
- **Telemetry Collection** – Anonymous usage data collection to help improve BetterKMR.
...
- **Danger Zone** renamed to **Advanced** – Now includes Offline Mode (Disable Telemetry or Helicon).
...
- **Telemetry** collects anonymous data on which settings and themes are in use, sent hourly – no personal info is collected. Refer to the Privacy Policy for full details.
